...
class UsuariosRejeitados extends StatefulWidget {
  @override
  _UsuariosRejeitadosState createState() => _UsuariosRejeitadosState();
}

class _UsuariosRejeitadosState extends State<UsuariosRejeitados> {
